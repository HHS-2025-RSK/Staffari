...
// export default function Home() {
//   const [playLeafVideo, setPlayLeafVideo] = useState(false);
...
//         {/* SCROLL TRIGGER */}
//         <ScrollTrigger onEnter={() => setPlayLeafVideo(true)} />

//         {/* LEAF TRANSITION VIDEO */}
//         {playLeafVideo && (
//           <LeafTransition
//             videoSrc="/videos/leaf.mp4"
//             onComplete={() => setPlayLeafVideo(false)}
//           />
//         )}

//         {/* NEXT SECTION (VISIBLE AFTER VIDEO) */}
//         <HiringProblemSection />
