...
export default function DownloadSection({
  ...
  const phoneReveal = useScrollReveal(0.2);
      ...
      <Container>
        ...
        <div className="mx-auto px-6 sm:px-12 py-12 sm:py-0">
          <div className="grid md:grid-cols-[1.3fr_0.7fr] items-center gap-10 md:gap-14">
            ...
            <div
              ref={cardReveal.ref}
              className={`rounded-[28px] bg-deepJungleGreen px-6 sm:px-12 py-12 sm:py-16 text-white order-2 md:order-1 transition-all duration-1000 ease-out ${cardReveal.isVisible
                  ? "opacity-100 translate-x-0"
                  : "opacity-0 -translate-x-16"
                }`}
            >
              <h2 className="font-display mt-3 text-3xl sm:text-4xl font-bold leading-tight max-w-lg">
            ...
            <div
              ref={phoneReveal.ref}
              className={`relative flex justify-center order-1 md:order-2 transition-all duration-[1200ms] ease-[cubic-bezier(0.22,1,0.36,1)] ${phoneReveal.isVisible
                  ? "opacity-100 translate-x-0 translate-y-0 scale-100"
                  : "opacity-0 translate-x-16 translate-y-8 scale-95"
                }`}
              onMouseEnter={() => setIsPaused(true)}
              onMouseLeave={() => setIsPaused(false)}
            >
