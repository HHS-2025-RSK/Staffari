...
// const BG_URL = "/images/contactus/image.png"; // public/images/contactus/image.png
...
//     <section
//       id="contact"
//       className="relative min-h-[520px] overflow-hidden py-16 bg-[#0f3d34]"
//     >
//       <div className="relative z-[2]">
//         <Container>
//           {/* CARD WITH IMAGE BACKGROUND */}
//           <div className="relative overflow-hidden rounded-3xl border border-mutedOlive/20 shadow-soft">
//             {/* Card background image */}
//             <div
//               aria-hidden="true"
//               className="pointer-events-none absolute inset-0 bg-cover bg-center contact-card-bg-fade"
//               style={{ backgroundImage: `url(${BG_URL})` }}
//             />

//             {/* Blur + tint overlay on top of image */}
//             <div
//               aria-hidden="true"
//               className="pointer-events-none absolute inset-0 bg-black/10 backdrop-blur-xs"
//             />

//             {/* Actual content */}
//             <div className="relative z-10 bg-cardBg/70 p-8 md:p-10">
//               <SectionTitle
//                 title="Contact Us"
...
//               {successOpen ? (
//                 <div className="mt-5 rounded-2xl border border-emeraldGreen/25 bg-white/80 px-4 py-3 font-body text-[14px] text-charcoalBlack backdrop-blur-sm">
//                   Thanks! Your details were submitted successfully. We’ll get
//                   back to you soon.
//                 </div>
//               ) : null}
...
function Modal({ open, title, onClose, children }) {
  ...
  return (
    ...
    >
      ...
      >
        <div className="flex items-start justify-between gap-4">
          <div className="font-body text-xl font-bold text-charcoalBlack">
            {title}
          </div>
          <button
            type="button"
  ...
  return (
    ...
    >
      {/* <img
        ...
        alt=""
        aria-hidden="true"
        className="pointer-events-none absolute bottom-0 left-0 right-0 z-[5] w-full object-cover"
      /> */}
      {/* Background image (fade in/out via CSS animation) */}
      <div
        aria-hidden="true"
      ...
      <div className="relative z-[1] mt-64">
        <div>
          ...
          <div className="relative overflow-hidden">
            ...
            {/* Overlay to make text/forms readable */}
            {/* <div className="pointer-events-none absolute inset-[5%] rounded-xl bg-white/65 backdrop-blur-sm" /> */}
